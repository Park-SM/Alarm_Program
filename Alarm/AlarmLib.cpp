...
int CheckingMousePos(ALARM **NewNode, int x, int y, int FocusWnd, bool click) {
	if (FocusWnd == 0) {
		...
		if (x > HB_LEFT && x < HB_RIGHT && y > HB_TOP && y < HB_BOTTOM) {
			...
			else if (click && x > X1 && x < X2 && y > Y0 && y < Y1) { (*NewNode)->time.Hou = 2;  return 21; }
			else if (click && x > X2 && x < X3 && y > Y0 && y < Y1) { (*NewNode)->time.Hou = 3;  return 22;	}
			else if (click && x > X3 && x < X4 && y > Y0 && y < Y1) { (*NewNode)->time.Hou = 4;  return 23; }
			else if (click && x > X4 && x < X5 && y > Y0 && y < Y1) { (*NewNode)->time.Hou = 5;  return 24; }
			else if (click && x > X5 && x < X6 && y > Y0 && y < Y1) { (*NewNode)->time.Hou = 6;  return 25; }
			else if (click && x > X6 && x < X7 && y > Y0 && y < Y1) { (*NewNode)->time.Hou = 7;  return 26; }
			else if (click && x > X7 && x < X8 && y > Y0 && y < Y1) { (*NewNode)->time.Hou = 8;  return 27; }
			else if (click && x > X8 && x < X9 && y > Y0 && y < Y1) { (*NewNode)->time.Hou = 9;  return 28; }
			else if (click && x > X9 && x < X10 && y > Y0 && y < Y1) { (*NewNode)->time.Hou = 10;  return 29; }
			else if (click && x > X10 && x < X11 && y > Y0 && y < Y1) { (*NewNode)->time.Hou = 11;  return 30; }
			else if (click && x > X11 && x < X12 && y > Y0 && y < Y1) { (*NewNode)->time.Hou = 12;  return 31; }

			else if (click && x > X0 && x < X1 && y > Y1 && y < Y2) { (*NewNode)->time.Hou = 13;  return 32; }
			else if (click && x > X1 && x < X2 && y > Y1 && y < Y2) { (*NewNode)->time.Hou = 14;  return 33; }
			else if (click && x > X2 && x < X3 && y > Y1 && y < Y2) { (*NewNode)->time.Hou = 15;  return 34; }
			else if (click && x > X3 && x < X4 && y > Y1 && y < Y2) { (*NewNode)->time.Hou = 16;  return 35; }
			else if (click && x > X4 && x < X5 && y > Y1 && y < Y2) { (*NewNode)->time.Hou = 17;  return 36; }
			else if (click && x > X5 && x < X6 && y > Y1 && y < Y2) { (*NewNode)->time.Hou = 18;  return 37; }
			else if (click && x > X6 && x < X7 && y > Y1 && y < Y2) { (*NewNode)->time.Hou = 19;  return 38; }
			else if (click && x > X7 && x < X8 && y > Y1 && y < Y2) { (*NewNode)->time.Hou = 20;  return 39; }
			else if (click && x > X8 && x < X9 && y > Y1 && y < Y2) { (*NewNode)->time.Hou = 21;  return 40; }
			else if (click && x > X9 && x < X10 && y > Y1 && y < Y2) { (*NewNode)->time.Hou = 22;  return 41; }
			else if (click && x > X10 && x < X11 && y > Y1 && y < Y2) { (*NewNode)->time.Hou = 23;  return 42; }
			else if (click && x > X11 && x < X12 && y > Y1 && y < Y2) { (*NewNode)->time.Hou = 00;  return 43; }
			else return 1; }
		else if (x > MB_LEFT && x < MB_RIGHT && y > MB_TOP && y < MB_BOTTOM) {
			if (click && x > X0 && x < X1 && y > Y3 && y < Y4) { (*NewNode)->time.Min = 0; return 50; }
			else if (click && x > X1 && x < X2 && y > Y3 && y < Y4) { (*NewNode)->time.Min = 1; return 51; }
			else if (click && x > X2 && x < X3 && y > Y3 && y < Y4) { (*NewNode)->time.Min = 2; return 52; }
			else if (click && x > X3 && x < X4 && y > Y3 && y < Y4) { (*NewNode)->time.Min = 3; return 53; }
			else if (click && x > X4 && x < X5 && y > Y3 && y < Y4) { (*NewNode)->time.Min = 4; return 54; }
			else if (click && x > X5 && x < X6 && y > Y3 && y < Y4) { (*NewNode)->time.Min = 5; return 55; }
			else if (click && x > X6 && x < X7 && y > Y3 && y < Y4) { (*NewNode)->time.Min = 6; return 56; }
			else if (click && x > X7 && x < X8 && y > Y3 && y < Y4) { (*NewNode)->time.Min = 7; return 57; }
			else if (click && x > X8 && x < X9 && y > Y3 && y < Y4) { (*NewNode)->time.Min = 8; return 58; }
			else if (click && x > X9 && x < X10 && y > Y3 && y < Y4) { (*NewNode)->time.Min = 9; return 59; }
			else if (click && x > X10 && x < X11 && y > Y3 && y < Y4) { (*NewNode)->time.Min = 10; return 60; }
			else if (click && x > X11 && x < X12 && y > Y3 && y < Y4) { (*NewNode)->time.Min = 11; return 61; }

			else if (click && x > X0 && x < X1 && y > Y4 && y < Y5) { (*NewNode)->time.Min = 12; return 62; }
			else if (click && x > X1 && x < X2 && y > Y4 && y < Y5) { (*NewNode)->time.Min = 13; return 63; }
			else if (click && x > X2 && x < X3 && y > Y4 && y < Y5) { (*NewNode)->time.Min = 14; return 64; }
			else if (click && x > X3 && x < X4 && y > Y4 && y < Y5) { (*NewNode)->time.Min = 15; return 65; }
			else if (click && x > X4 && x < X5 && y > Y4 && y < Y5) { (*NewNode)->time.Min = 16; return 66; }
			else if (click && x > X5 && x < X6 && y > Y4 && y < Y5) { (*NewNode)->time.Min = 17; return 67; }
			else if (click && x > X6 && x < X7 && y > Y4 && y < Y5) { (*NewNode)->time.Min = 18; return 68; }
			else if (click && x > X7 && x < X8 && y > Y4 && y < Y5) { (*NewNode)->time.Min = 19; return 69; }
			else if (click && x > X8 && x < X9 && y > Y4 && y < Y5) { (*NewNode)->time.Min = 20; return 70; }
			else if (click && x > X9 && x < X10 && y > Y4 && y < Y5) { (*NewNode)->time.Min = 21; return 71; }
			else if (click && x > X10 && x < X11 && y > Y4 && y < Y5) { (*NewNode)->time.Min = 22; return 72; }
			else if (click && x > X11 && x < X12 && y > Y4 && y < Y5) { (*NewNode)->time.Min = 23; return 73; }

			else if (click && x > X0 && x < X1 && y > Y5 && y < Y6) { (*NewNode)->time.Min = 24; return 74; }
			else if (click && x > X1 && x < X2 && y > Y5 && y < Y6) { (*NewNode)->time.Min = 25; return 75; }
			else if (click && x > X2 && x < X3 && y > Y5 && y < Y6) { (*NewNode)->time.Min = 26; return 76; }
			else if (click && x > X3 && x < X4 && y > Y5 && y < Y6) { (*NewNode)->time.Min = 27; return 77; }
			else if (click && x > X4 && x < X5 && y > Y5 && y < Y6) { (*NewNode)->time.Min = 28; return 78; }
			else if (click && x > X5 && x < X6 && y > Y5 && y < Y6) { (*NewNode)->time.Min = 29; return 79; }
			else if (click && x > X6 && x < X7 && y > Y5 && y < Y6) { (*NewNode)->time.Min = 30; return 80; }
			else if (click && x > X7 && x < X8 && y > Y5 && y < Y6) { (*NewNode)->time.Min = 31; return 81; }
			else if (click && x > X8 && x < X9 && y > Y5 && y < Y6) { (*NewNode)->time.Min = 32; return 82; }
			else if (click && x > X9 && x < X10 && y > Y5 && y < Y6) { (*NewNode)->time.Min = 33; return 83; }
			else if (click && x > X10 && x < X11 && y > Y5 && y < Y6) { (*NewNode)->time.Min = 34; return 84; }
			else if (click && x > X11 && x < X12 && y > Y5 && y < Y6) { (*NewNode)->time.Min = 35; return 85; }

			else if (click && x > X0 && x < X1 && y > Y6 && y < Y7) { (*NewNode)->time.Min = 36; return 86; }
			else if (click && x > X1 && x < X2 && y > Y6 && y < Y7) { (*NewNode)->time.Min = 37; return 87; }
			else if (click && x > X2 && x < X3 && y > Y6 && y < Y7) { (*NewNode)->time.Min = 38; return 88; }
			else if (click && x > X3 && x < X4 && y > Y6 && y < Y7) { (*NewNode)->time.Min = 39; return 89; }
			else if (click && x > X4 && x < X5 && y > Y6 && y < Y7) { (*NewNode)->time.Min = 40; return 90; }
			else if (click && x > X5 && x < X6 && y > Y6 && y < Y7) { (*NewNode)->time.Min = 41; return 91; }
			else if (click && x > X6 && x < X7 && y > Y6 && y < Y7) { (*NewNode)->time.Min = 42; return 92; }
			else if (click && x > X7 && x < X8 && y > Y6 && y < Y7) { (*NewNode)->time.Min = 43; return 93; }
			else if (click && x > X8 && x < X9 && y > Y6 && y < Y7) { (*NewNode)->time.Min = 44; return 94; }
			else if (click && x > X9 && x < X10 && y > Y6 && y < Y7) { (*NewNode)->time.Min = 45; return 95; }
			else if (click && x > X10 && x < X11 && y > Y6 && y < Y7) { (*NewNode)->time.Min = 46; return 96; }
			else if (click && x > X11 && x < X12 && y > Y6 && y < Y7) { (*NewNode)->time.Min = 47; return 97; }

			else if (click && x > X0 && x < X1 && y > Y7 && y < Y8) { (*NewNode)->time.Min = 48; return 98; }
			else if (click && x > X1 && x < X2 && y > Y7 && y < Y8) { (*NewNode)->time.Min = 49; return 99; }
			else if (click && x > X2 && x < X3 && y > Y7 && y < Y8) { (*NewNode)->time.Min = 50; return 100; }
			else if (click && x > X3 && x < X4 && y > Y7 && y < Y8) { (*NewNode)->time.Min = 51; return 101; }
			else if (click && x > X4 && x < X5 && y > Y7 && y < Y8) { (*NewNode)->time.Min = 52; return 102; }
			else if (click && x > X5 && x < X6 && y > Y7 && y < Y8) { (*NewNode)->time.Min = 53; return 103; }
			else if (click && x > X6 && x < X7 && y > Y7 && y < Y8) { (*NewNode)->time.Min = 54; return 104; }
			else if (click && x > X7 && x < X8 && y > Y7 && y < Y8) { (*NewNode)->time.Min = 55; return 105; }
			else if (click && x > X8 && x < X9 && y > Y7 && y < Y8) { (*NewNode)->time.Min = 56; return 106; }
			else if (click && x > X9 && x < X10 && y > Y7 && y < Y8) { (*NewNode)->time.Min = 57; return 107; }
			else if (click && x > X10 && x < X11 && y > Y7 && y < Y8) { (*NewNode)->time.Min = 58; return 108; }
			else if (click && x > X11 && x < X12 && y > Y7 && y < Y8) { (*NewNode)->time.Min = 59; return 109; }
			else return 2;
		}
...
void AppearAddMenu(HINSTANCE Instance, HWND hWnd, HDC hdc, TIME tSelectedTime, LPWSTR MemoData, ALARM **NewNode, bool *AddMenuFirstMotion, int *FocusWnd) {
	...
	Font = CreateFont(13, 0, 1, 0, 0, 0, 0, 0, HANGEUL_CHARSET, 0, 0, 0, 0, L"굴림체");
